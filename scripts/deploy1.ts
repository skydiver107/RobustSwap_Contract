...
async function main() {
  ...
  // tx = await swapmining.addPair(100, pair12address, true);
  // await tx.wait();
  // tx = await swapmining.addPair(100, pair20address, true);
  // await tx.wait();
  // tx = await swapmining.addPair(100, pair01address, true);
  // await tx.wait();
  ...
  // tx = await masterchef.add(200, pair12address, 100, 14 * 86400, true);
  // await tx.wait();
  // tx = await masterchef.add(200, pair20address, 100, 14 * 86400, true);
  // await tx.wait();
  // tx = await masterchef.add(200, pair01address, 100, 14 * 86400, true);
  // await tx.wait();
